...
`
      ...
      const ExistingAccount = styled.div`
            ...
            gap: 5px;
      `
      const ExistingAccountSpan = styled.span`
            font-family: 'Montserrat';
            font-style: normal;
            font-weight: 500;
            font-size: 15px;
  ...
  return (
    <Login>
        ...
        <ExistingAccount>
            <ExistingAccountSpan>Already have an account?</ExistingAccountSpan>
            <StyledLink to='/Login'><SignInSpan>Sign in!</SignInSpan></StyledLink>
        </ExistingAccount>
    </Login>
  )
}
